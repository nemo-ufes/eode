...
public class ActivityStandardProcess {
	...
	private KArtefact products;
	private KArtefact inputs;
	...
	/** Getter for products. */
	public KArtefact getProducts() {
		return products;
	}
	/** Setter for products. */
	public void setProducts(KArtefact products) {
		this.products = products;
	}
	/** Getter for inputs. */
	public KArtefact getInputs() {
		return inputs;
	}
	/** Setter for inputs. */
	public void setInputs(KArtefact inputs) {
		this.inputs = inputs;
	}
