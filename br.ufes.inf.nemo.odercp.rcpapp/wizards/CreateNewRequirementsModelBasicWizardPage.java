package br.ufes.inf.nemo.odercp.rcpapp.wizards;
...
public class CreateNewRequirementsModelBasicWizardPage extends WizardPage implements KeyListener {
	...
	public CreateNewRequirementsModelBasicWizardPage() {
		super(Messages.getString("gui.createNewRequirementsModelWizard.basicPage.title")); //$NON-NLS-1$
		setTitle(Messages.getString("gui.createNewRequirementsModelWizard.basicPage.title")); //$NON-NLS-1$
	}
	...
	public void createControl(Composite parent) {
		...
		projectLabel.setText(Messages.getString("gui.createNewRequirementsModelWizard.basicPage.field.project")); //$NON-NLS-1$
		...
		nameLabel.setText(Messages.getString("gui.createNewRequirementsModelWizard.basicPage.field.name")); //$NON-NLS-1$
		...
		basePackageLabel.setText(Messages.getString("gui.createNewRequirementsModelWizard.basicPage.field.basePackage")); //$NON-NLS-1$
